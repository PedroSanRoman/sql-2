...
UPDATE usuarios SET id_categoria = 2 WHERE id_usuario IN (2, 4);
UPDATE usuarios SET id_categoria = 3 WHERE id_usuario IN (5, 7);
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (6, 8);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (9, 11);
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (10, 12);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (13, 15);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (14, 16);
UPDATE usuarios SET id_categoria = 9 WHERE id_usuario IN (16, 18);
UPDATE usuarios SET id_categoria = 10 WHERE id_usuario IN (17, 19, 20);
